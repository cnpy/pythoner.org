...
def register(request):
    ...
    if request.method == 'GET':
        if TURN_OFF:
            return render('accounts/account_register_off.html', locals())
        else:
            form = RegisterForm()
            return render('accounts/account_register.html', locals(), context_instance=RequestContext(request))
...
def login(request):
    ...
    if request.method == 'GET':
        ...
        form = LoginForm()
        return render('accounts/account_login.html', locals(), context_instance=RequestContext(request))
